...
do 
    ...
    do
        ...
        do
            ...
            python ../envs/quad3d_free.py --task ${task} --dynamics bodyrate --controller ${controller} --mode eval --controller_params "N${N}_H${H}_lam${lam}" --name "quad3d_${task}_${controller}_N${N}_H${H}_lam${lam}" --debug
        done
    done
done
